...
def prediction(tenthCgpa, percent_12, btech_cgpa, activebacklogs, passivebacklogs, gender, internship, branch, category):  
    ...
    prediction = student_classifier.predict(
        [[tenthCgpa, percent_12, btech_cgpa, activebacklogs, passivebacklogs, gender, internship, branch, category]])
    #print(prediction)
    return prediction
...
def main():
    ...
    btech_cgpa = st.text_input("BTech CGPA")
    ...
    if st.button("Predict"):
        result = prediction(tenthCgpa, percent_12, btech_cgpa, activebacklogs, passivebacklogs, gender, internship, branch, category)
        if result == 0:
